...
public class ResourceData {
    ...
    private static String getEmulatorText() {
        return ActManager.getCurrentActivity().getResources().getString(R.string.tab_emulator);
    }
}
