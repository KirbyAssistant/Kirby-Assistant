...
public class LanguageUtil {
    public static void setLanguage()
    {
        ...
        SharedPreferences preferences = ActManager.getCurrentActivity(). getSharedPreferences("setting", 0);
        String language = preferences.getString("language", "auto");

        //根据读取到的数据，进行设置
        Resources resources = ActManager.getCurrentActivity().getResources();
