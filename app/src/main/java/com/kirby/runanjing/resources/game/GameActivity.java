package com.kirby.runanjing.resources.game;
				...
				public void onClick(View p1)
				{
					switch (game_pos)
					{
						...
						case "gba_jm"://"星之卡比 镜之大迷宫":
							showDownloadDialog(game_name,  R.string.game_name, R.string.dia_jp, R.string.dia_us, R.string.dia_zh, "https://eyun.baidu.com/s/3hs7Mjsg", "https://eyun.baidu.com/s/3c5qBl8", "https://eyun.baidu.com/s/3i5t6Z3J");
							break;
						case "sfc_x3"://"星之卡比 3":
						...
						case "n64_k64"://"星之卡比 64":
							showDownloadDialog(game_name,  R.string.game_name, R.string.dia_jp, R.string.dia_us, R.string.dia_nu, "https://eyun.baidu.com/s/3jHPKdMY", "https://eyun.baidu.com/s/3jHPKdMY", "");
							break;
						case "ngc_ft"://"星之卡比 飞天赛车":
							showDownloadDialog(game_name,  R.string.game_name, R.string.dia_us, R.string.dia_nu, R.string.dia_nu, "https://eyun.baidu.com/s/3qYAoXGC", "", "");
							break;
						case "wii_cf"://"星之卡比 重返梦幻岛":
							showDownloadDialog(game_name, R.string.game_name, R.string.dia_jp, R.string.dia_us, R.string.dia_zh, "https://eyun.baidu.com/s/3skEbla1", "https://eyun.baidu.com/s/3gf5Oxe7", "https://eyun.baidu.com/s/3gfqpuin");
							break;
						case "wii_mx"://"星之卡比 毛线卡比":
							showDownloadDialog(game_name, R.string.game_name, R.string.dia_jp, R.string.dia_us, R.string.dia_zh, "https://eyun.baidu.com/s/3i5UCDpz", "https://eyun.baidu.com/s/3dFACfWd", "https://eyun.baidu.com/s/3eRYayD8");
							break;
						case "nds_cm"://"星之卡比 触摸卡比":
							showDownloadDialog(game_name,  R.string.game_name, R.string.dia_jp, R.string.dia_us, R.string.dia_zh, "https://eyun.baidu.com/s/3hsqS3S4", "https://eyun.baidu.com/s/3c27V89i", "https://eyun.baidu.com/s/3i5Pwsxn");
							break;
						case "nds_kssu"://"星之卡比 超究豪华版":
							showDownloadDialog(game_name,  R.string.game_name, R.string.dia_jp, R.string.dia_us, R.string.dia_zh, "https://eyun.baidu.com/s/3i4Ricbb", "https://eyun.baidu.com/s/3nvCwXlB", "https://eyun.baidu.com/s/3c2EblZi");
							break;
						case "nds_nht"://"星之卡比 呐喊团":
							showDownloadDialog(game_name,  R.string.game_name, R.string.dia_jp, R.string.dia_us, R.string.dia_zh, "https://eyun.baidu.com/s/3bo4Z5TH", "https://eyun.baidu.com/s/3czmilC", "https://eyun.baidu.com/s/3hr4PxbA");
							break;
						case "nds_jh"://"星之卡比 集合！卡比":
							showDownloadDialog(game_name,  R.string.game_name, R.string.dia_jp, R.string.dia_us, R.string.dia_zh, "https://eyun.baidu.com/s/3geO4mbx", "https://eyun.baidu.com/s/3eSijdHS", "https://eyun.baidu.com/s/3o80PA6e");
							break;
						case "gb_x1"://"星之卡比 1":
							showDownloadDialog(game_name,  R.string.game_name, R.string.dia_jp, R.string.dia_us, R.string.dia_nu, "https://eyun.baidu.com/s/3pKN6dIz", "https://eyun.baidu.com/s/3miPUVES", "");
							break;
						case "gb_x2"://"星之卡比 2":
							showDownloadDialog(game_name,  R.string.game_name, R.string.dia_jp, R.string.dia_us, R.string.dia_nu, "https://eyun.baidu.com/s/3i57Kjjv", "https://eyun.baidu.com/s/3jI4urlW", "");
							break;
						case "gb_bsx"://"星之卡比 卡比宝石星":
							showDownloadDialog(game_name,  R.string.game_name, R.string.dia_jp, R.string.dia_us, R.string.dia_nu, "https://eyun.baidu.com/s/3miFgbtI", "https://eyun.baidu.com/s/3nvtzunn", "");
							break;
						case "gb_dzk"://"星之卡比 卡比打砖块":
							showDownloadDialog(game_name,  R.string.game_name, R.string.dia_jp, R.string.dia_us, R.string.dia_nu, "https://eyun.baidu.com/s/3i5Dkqah", "https://eyun.baidu.com/s/3ge7808r", "");
							break;
