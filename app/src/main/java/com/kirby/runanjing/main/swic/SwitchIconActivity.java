package com.kirby.runanjing.main.swic;
...
public class SwitchIconActivity extends BaseActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        HkComponent = new ComponentName(getBaseContext(), "com.kirby.runanjing.launcher.Launcher");  //拿到默认的组件
        //拿到我注册的别名test组件
        MaComponent = new ComponentName(getBaseContext(), "com.kirby.runanjing.launcher.OtherLauncher");
